                    ...
                    <div class="card-body">
                        ...
                        <div class="filter-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="studentSearch" class="form-control form-control-sm" placeholder="Enter student name...">
                            </div>
                                ...
                                <a href="<?php echo $relative_path; ?>modules/registrar/requirements.php?student_id=<?php echo $student['id']; ?>" 
                                   ...
                                   data-requirements="<?php echo $student['requirements_complete'] == 1 ? 'complete' : 'incomplete'; ?>">
                                    ...
                                    <span class="badge <?php 
                                        ...
                                        elseif ($student['enrollment_status'] === 'pending') echo 'bg-warning';
                                        else echo 'bg-info';
                                    ?> rounded-pill">
